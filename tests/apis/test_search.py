...
def test_search_tweets(api, helpers):
    ...
    tweets_data = helpers.load_json_data("testdata/apis/searches/search_tweets_for_nyc.json")
    responses.add(
        responses.GET,
    ...
    tweets_data = helpers.load_json_data("testdata/apis/searches/search_tweets_query.json")
    responses.add(
        responses.GET,
